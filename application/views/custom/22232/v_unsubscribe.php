                        ...
                        <div class="col_6 pre_3 padding_top_120">
                            <div class="widget clearfix">
                                ...
                                <div class="widget_inside">
                                    <?php echo '<h3 class="margin_bottom_5">Hi ' . element('FirstName', $fields, '') . '</h3>';
                                        echo '<h4 class="">How do you want us to keep in touch with you?</h4>';
                                    ?>
                                    <?php echo $this->message; ?>
                                    <div class="form margin_top_15">
                                        <?php echo form_open('unsubscribe/edit/' . $this->uri->segment(3)); ?>
                                    ...
                                    <div class="form margin_top_45">
                                        <div class="clearfix center margin_top_15">
                                            <h3 class="margin_bottom_15 margin_top_15"><a href="<?php echo site_url('unsubscribe/remove/' . $this->uri->segment(3)); ?>" class="button red padding_top_15 padding_bottom_15 ">Unsubscribe from Everything</a></h3>
