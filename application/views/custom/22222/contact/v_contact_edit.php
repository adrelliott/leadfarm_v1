            ...
            <div class="widget clearfix tabs">
                ...
                <div class="widget_inside">
                    ...
                    <div id="tab-4">
                        ...
                        <div class="clearfix margin_top_15">
                            <a href="<?php echo site_url("/vehicles/view_modal/edit_modal/new/$ContactId"); ?>" class="large blue button right iframe" data-table-id="tab-4">
            ...
            <div class="widget clearfix tabs">
                ...
                <div class="widget_inside">
                    <div id="tab-5">
                        ...
                        <div class="clearfix margin_top_15">
                           <a href="<?php echo site_url("contactaction/view/edit_action/new/$ContactId"); ?>" class="large blue button right iframe" data-table-id="tab-5">
                    ...
                    <div id="tab-6">
                        ...
                        <div class="clearfix margin_top_15">
                           <a href="<?php echo site_url("contactaction/view/edit_booking/new/$ContactId"); ?>" class="large blue button right iframe" data-table-id="tab-6">
