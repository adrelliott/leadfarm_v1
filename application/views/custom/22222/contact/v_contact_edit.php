            ...
            <div class="widget clearfix tabs">
                ...
                <div class="widget_inside">
                    ...
                    <div id="tab-6">
                        ...
                        <div class="clearfix margin_top_15">
                           <a href="<?php echo site_url(DATAOWNER_ID . "/contactaction/view/edit_booking/new/$ContactId"); ?>" class="large blue button right iframe" data-table-id="tab-6">
                    ...
                    <div id="tab-7">
                        ...
                        <div class="clearfix margin_top_15">
                            <a href="<?php echo site_url(DATAOWNER_ID . "/comms/view/new/new/$ContactId"); ?>" class="large blue button right iframe" data-table-id="tab-7">
